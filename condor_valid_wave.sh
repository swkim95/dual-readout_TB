...
python3 ./test/TBvalid.py -rn $1 -id "dcap://cluster142.knu.ac.kr//pnfs/knu.ac.kr/data/cms/store/user/sungwon/2022_DRC_TB_Data/" -in "dcap://cluster142.knu.ac.kr//pnfs/knu.ac.kr/data/cms/store/user/sungwon/2022_DRC_TB_ntuple/waveform/" -o "./test/valid_plot/" | tee -a /u/user/swkim/dual-readout_TB/test/valid_tee_log/wave/wave_valid_fullLog_$1.log